...
%\documentclass[accepted]{tpm2026} % after acceptance, for a revised version;
% also before submission to see how the non-anonymous paper would look like

%% There is a class option to choose the math font
% \documentclass[mathfont=ptmx]{tpm2026} % ptmx math instead of Computer
                                         % Modern (has noticeable issues)
% \documentclass[mathfont=newtx]{tpm2026} % newtx fonts (improves upon
...
%
% Add authors
\author[1]{\href{mailto:<jj@example.edu>?Subject=Your TPM 2026 paper}{Jane~J.~von~O'L\'opez}{}}
...
TPM 2026 papers have to be prepared using \LaTeX.
To start writing your paper, copy \texttt{tpm2026-template.tex} and replace title, authorship, and content with your own.

The TPM 2026 paper style is based on a custom \textsf{tpm2026} class.
...
You are free to load any packages available in \TeX{Live}~2020 that are compatible with the TPM class.\footnote{In case this template or your submission does not compile, always first make sure your \TeX\ installation is up-to-date.}
...
\begin{figure}[!htb]
  \centering
  \includegraphics[width=\linewidth]{Amsterdam.jpg}
